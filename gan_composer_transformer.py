...
class GAN:
    ...
    def __init__(self, g_in_seq_len=128, g_out_seq_len=512, g_en_max_pos=5000, g_de_max_pos=50000,
                 g_embed_dim=256, g_n_heads=4, g_in_notes_pool_size=8000, g_out_notes_pool_size=8000,
                 g_fc_activation="relu", g_encoder_layers=2, g_decoder_layers=2,
